...
<head>
    ...
    <meta name="twitter:title" content="Lista de Productos-Administrador">
    ...
    <title>Lista de Productos-Administrador</title>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center mt-4">
                <div class="col-lg-8 mx-auto mbr-form" data-form-type="formoid">
                    <form action="../Administrador ZCYL/CRUD_Productos/registrar.php" method="POST"
                    ...
                    <div class="item-wrapper">
                        ...
                        <div class="mbr-section-btn item-footer mt-2">
                            ...
                            <a class="btn btn-info display-4"
                                href="a16.php?id=<?php echo $field1name ?>&nombre=<?php echo $field2name ?>&valor=<?php echo $field3name ?>">Editar</a>
                                <a class="btn btn-info display-4" href="..\Administrador ZCYL\CRUD_Productos\eliminar.php?id=<?php echo $field1name ?>">Eliminar</a>
                        </div>
                    </div>
                </div>
                <?php
