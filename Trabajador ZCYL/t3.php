...
<head>
    ...
    <meta name="twitter:title" content="Editar Material-Trabajador">
    ...
    <title>Editar Material-Trabajador</title>
...
<body>
    ...
    <section data-bs-version="5.1" class="menu menu2 cid-tmEIsLal42" once="menu" id="menu2-4f">
    ...
    <section data-bs-version="5.1" class="team2 cid-tmEIViUdCT" xmlns="http://www.w3.org/1999/html" id="team2-4j">
        <div class="container">
            <div class="card">
                    ...
                    <div class="row align-items-center">
                        <div class="col-12 col-md-4">
                            <div class="image-wrapper">
                                <img src="assets/images/maxresdefault-1-1139x641.jpeg" alt="Mobirise Website Builder">
                            </div>
                        </div>
    ...
    <section data-bs-version="5.1" class="header5 cid-tmEIsJLISa" id="header5-4e">
            ...
            <div class="row justify-content-end">
                <div class="col-12 col-lg-10">
                    <div class="mbr-section-btn mt-3">
                        <a class="btn btn-info display-7" href="t2.php">Regresar</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section data-bs-version="5.1" class="contacts1 cid-tmIkngiwpx" id="contacts1-60">
