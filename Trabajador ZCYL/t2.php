...
<head>
    ...
    <meta name="twitter:title" content="Lista de materiales-Trabajador">
    ...
    <title>Lista de materiales-Trabajador</title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center mt-4">
                <div class="col-lg-8 mx-auto mbr-form" data-form-type="formoid">
                    <form action="../Trabajador ZCYL/CRUD_Materiales/registrar.php" method="POST"
    ...
    <section data-bs-version="5.1" class="header5 cid-tmEF3H7HyR" id="header5-49">
        <div class="container">
            <div class="row justify-content-end">
                <div class="col-12 col-lg-9">
                    <div class="mbr-section-btn mt-3"><a class="btn btn-info display-7" href="t2.php"><span
                    ...
                    <div class="item-wrapper">
                        ...
                        <div class="mbr-section-btn item-footer mt-2">
                            ...
                            <a class="btn btn-info display-4"
                                href="t12.php?id=<?php echo $field1name ?>&nombre=<?php echo $field2name ?>&valor=<?php echo $field3name ?>">Editar</a>
                        </div>
                    </div>
                </div>
                <?php
