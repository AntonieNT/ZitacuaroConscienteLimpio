...
<head>
    ...
    <meta name="twitter:title" content="Editar Productos-Administrador">
    ...
    <title>Editar Productos-Administrador</title>
...
<body>
                            ...
                            <div class="card-box">
                                ...
                                <div class="row justify-content-center mt-4">
                                    <div class="col-lg-8 mx-auto mbr-form" data-form-type="formoid">
                                        <form
                                            action="../Administrador ZCYL/CRUD_Productos/modificar.php?id=<?php echo $_GET["id"]; ?>"
    ...
    <section data-bs-version="5.1" class="header5 cid-tmHUdrj7Ws" id="header5-5q">
        <div class="container">
            <div class="row justify-content-end">
                <div class="col-12 col-lg-9">
                    <div class="mbr-section-btn mt-3">
                        <a class="btn btn-info display-7" href="a4.php">Regresar</a>
                    </div>
                </div>
            </div>
        </div>
