...
<head>
    ...
    <meta name="twitter:title" content="Editar Trabajadores-Administrador">
    ...
    <title>Editar Trabajadores-Administrador</title>
...
<body>
    ...
    <section data-bs-version="5.1" class="menu menu2 cid-tmKuV6rGWU" once="menu" id="menu2-6g">
    ...
    <section data-bs-version="5.1" class="team2 cid-tmKuV28m2p" xmlns="http://www.w3.org/1999/html" id="team2-6e">
                        ...
                        <div class="col-12 col-md">
                            <div class="card-box">
                                ...
                                <h6 class="card-subtitle mbr-fonts-style mb-3 display-4">
                                    <strong><br></strong><br><strong>Trabajador</strong>
                                </h6>
                                <form action="../Administrador ZCYL/CRUD_Trabajadores/modificar.php?id=<?php echo $_GET["id"]; ?>" method="POST"
    ...
    <section data-bs-version="5.1" class="header5 cid-tmFcDI5Wgf" id="header5-5b">
        <div class="container">
            <div class="row justify-content-end">
                <div class="col-12 col-lg-9">
                    <div class="mbr-section-btn mt-3">
                        <a class="btn btn-info display-7" href="a10.php">Regresar</a>
                    </div>
                </div>
            </div>
        </div>
