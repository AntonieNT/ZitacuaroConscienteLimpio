...
<head>
    ...
    <meta name="twitter:title" content="Usuarios-Administrador">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center mt-4">
                <div class="col-lg-8 mx-auto mbr-form" data-form-type="formoid">
                    <form action="../Administrador ZCYL/CRUD_Usuarios/registrar.php" method="POST"
    ...
    <section data-bs-version="5.1" class="header5 cid-tmIbSM93TX" id="header5-5y">
        <div class="container">
            <div class="row justify-content-end">
                <div class="col-12 col-lg-9">
                    <div class="mbr-section-btn mt-3">
                        <a class="btn btn-info display-7" href="a8.php"><span
                ...
                <div class="card col-12 col-md-6 col-lg-4">
                    ...
                    <div class="card-wrapper">
                        ...
                        <div class="card-box align-center">
                            ...
                            <div class="mbr-section-btn mt-3">
                            <a class="btn btn-info display-4" href="..\Administrador ZCYL\CRUD_Usuarios\ver.php?id=<?php echo $field1name ?>">Ver</a>
                            <a class="btn btn-info display-4" href="a13.php?id=<?php echo $field1name ?>&curp=<?php echo $field2name ?>&telefono=<?php echo $field3name ?>&email=<?php echo $field4name ?>&password=<?php echo $field5name ?>">Editar</a>
                            <a class="btn btn-info display-4" href="..\Administrador ZCYL\CRUD_Usuarios\eliminar.php?id=<?php echo $field1name ?>">Eliminar</a>
