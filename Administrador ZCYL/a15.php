...
<head>
    ...
    <meta name="twitter:title" content="Editar Material-Administrador">
    ...
    <title>Editar Material-Administrador</title>
...
<body>
                            ...
                            <div class="card-box">
                                ...
                                <div class="row justify-content-center mt-4">
                                    <div class="col-lg-8 mx-auto mbr-form" data-form-type="formoid">
                                        <form action="../Administrador ZCYL/CRUD_Materiales/modificar.php?id=<?php echo $_GET["id"]; ?>" method="POST"
    ...
    <div class="container">
            <div class="row justify-content-end">
                <div class="col-12 col-lg-9">
                    <div class="mbr-section-btn mt-3">
                        <a class="btn btn-info display-7" href="a2.php">Regresar</a>
                    </div>
                </div>
            </div>
        </div>
