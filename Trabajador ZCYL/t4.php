...
<head>
    ...
    <meta name="twitter:title" content="Lista de Productos-Trabajador">
    ...
    <title>Lista de Productos-Trabajador</title>
...
<body>
    ...
    <section data-bs-version="5.1" class="menu menu2 cid-tmHTWRSRtH" once="menu" id="menu2-5l">
    ...
    <section data-bs-version="5.1" class="form6 cid-tmHTWMiCOs" id="form6-5j">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center mt-4">
                <div class="col-lg-8 mx-auto mbr-form" data-form-type="formoid">
                    <form action="../Trabajador ZCYL/CRUD_Productos/registrar.php" method="POST"
    ...
    <section data-bs-version="5.1" class="header5 cid-tmHTWOK48O" id="header5-5k">
        <div class="container">
            <div class="row justify-content-end">
                <div class="col-12 col-lg-10">
                    <div class="mbr-section-btn mt-3"><a class="btn btn-info display-7" href="t4.php"><span
                                class="mbri-search mbr-iconfont mbr-iconfont-btn"></span>Buscar Producto</a></div>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="item-wrapper">
                        ...
                        <div class="mbr-section-btn item-footer mt-2">
                            ...
                            <a class="btn btn-info display-4"
                                href="t11.php?id=<?php echo $field1name ?>&nombre=<?php echo $field2name ?>&valor=<?php echo $field3name ?>">Editar</a>
                        </div>
                    </div>
                </div>
                <?php
    ...
    <section data-bs-version="5.1" class="contacts1 cid-tmEGCHcsxT" id="contacts1-4c">
        <div class="container">
            <div class="mbr-section-head">
                <h3 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2">
